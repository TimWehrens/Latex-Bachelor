...
\textbf{TF3.} F\"ur alle vier Kennzahlen ergeben sich positive Wirkungsrichtungen, die jedoch nicht gleichgerichtet ausfallen. Die First Contact Resolution Rate ist nach der Umgestaltung nur getrennt nach Kan\"alen interpretierbar, weil der Self-Service die einfachen F\"alle aus dem Agenten-Kanal herausl\"ost. Die Grenzen liegen in den vier in Abschnitt~\ref{zusammenfassung} genannten Feldern, die s\"amtlich an der Verl\"asslichkeit maschineller Ausgaben ansetzen und nicht an der Aufteilung zwischen Maschine und Mensch.
